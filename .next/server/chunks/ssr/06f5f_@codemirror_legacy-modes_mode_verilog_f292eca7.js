module.exports = [
"[project]/node_modules/.pnpm/@codemirror+legacy-modes@6.5.1/node_modules/@codemirror/legacy-modes/mode/verilog.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            if (state.tlvCodeActive) {
                ...
                if (style !== undefined) {} else if (state.tlvInBlockComment) {
                    ...
                    if (stream.match(/^.*?\*\//)) {
                        ...
                        if (tlvTrackStatements && !stream.eol()) //TURBOPACK unreachable
                        ;
                    } else {
                        stream.skipToEnd();
                    }
...
//# sourceMappingURL=06f5f_%40codemirror_legacy-modes_mode_verilog_f292eca7.js.map